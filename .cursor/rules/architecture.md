...
- **GDScript performance:** For chunk streaming, procedural generation, fog, or other hot-path systems, follow [godot-performance.mdc](godot-performance.mdc). The Self-Correction Step must include holistic pipeline traps + bypasses before implementation.
