...
func _physics_process(delta: float) -> void:
	...
	var max_speed: float = _max_speed_for_zoom(zoom)
	...
	var snap_threshold_sq: float = Settings.get_float("player_movement.velocity_snap_threshold_sq")
	if velocity.length_squared() < snap_threshold_sq:
